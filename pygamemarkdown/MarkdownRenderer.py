...
class MarkdownRenderer:
    ...
    from ._visibility_checks import is_visible, is_above_area, is_below_area
    ...
    def display(self, pygame_events, mouse_x, mouse_y) -> None:
        ...
        if self.pixel_first_showable == 0:
            # first time to run, we set the entire length of the text
