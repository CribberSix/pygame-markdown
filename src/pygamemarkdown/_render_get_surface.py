...
def get_surface(self, word: str, t_type: str) -> pygame.Surface:
    ...
    """
    if t_type == 'h1':
        return self.font_header.render(word, True, self.font_color)
    elif t_type == 'h2':
        return self.font_header2.render(word, True, self.font_color)
    elif t_type == 'h3':
        return self.font_header3.render(word, True, self.font_color)
        ...
        return self.font_text.render(word, True, self.font_color)
    elif t_type == 'text':
        return self.font_text.render(word, True, self.font_color)
    else:
        return self.font_text.render(word, True, self.font_color)
